...
public enum FixtureStatisticsQueries {
    ...
    CORE_COLUMNS("fs.fixture_id, fs.team_id, fs.shots_on_goal, fs.shots_off_goal, fs.total_shots, fs.blocked_shots, fs.shots_inside_box, " +
            ...
            "fs.total_passes, fs.passes_accurate, fs.passes_percent, fs.expected_goals "),
